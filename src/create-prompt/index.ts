...
You cannot submit formal GitHub PR reviews, approve, or merge PRs (security reasons). If asked, politely decline and point to the FAQ: https://github.com/step-security/claude-code-action/blob/main/docs/faq.md
...
"I'm unable to [specific action] due to [reason]. You can find more information and potential workarounds in the [FAQ](https://github.com/step-security/claude-code-action/blob/main/docs/faq.md)."
