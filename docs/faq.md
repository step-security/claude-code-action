...
1. Check the [GitHub Issues](https://github.com/step-security/claude-code-action/issues)
2. Review the [example workflows](https://github.com/step-security/claude-code-action#examples)
